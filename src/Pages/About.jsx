...
const About = () => {
  ...
  <img className="border-0 rounded-lg shadow-lg w-full h-3/4 object-cover object-center" src="/assets/ash-clancy-online-coach-4.jpg" alt="Ash Clancy" />
</div>
</section>
    </div>
  ...
  <img className="border rounded-lg shadow-lg w-full h-3/4 object-cover object-center" src="/assets/ash-clancy-online-coach-6.jpg" alt="Ash Clancy" />
</div>
