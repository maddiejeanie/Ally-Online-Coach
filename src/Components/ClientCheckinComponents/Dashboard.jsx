    ...
    <div className="text-s flex flex-col items-center justify-center my-4 mx-auto sm:w-1/2">
      <div className="bg-gray-100 p-8 rounded-lg shadow-2xl w-2/3">
        <div className="text-s flex flex-col items-center justify-center my-4 mx-auto sm:w-1/2">
          ...
          <h2 className="mt-8 h2 text-3xl uppercase text-shadow flex justify-center text-indigo-500">Dashboard</h2>
        
<div className="text-s flex flex-col items-center justify-center text-center">        
<Link
          to="/clients/posts"
        ...
        <Link
          ...
          className="w-full px-4 py-2 my-2 border border-indigo-500 text-indigo-700 bg-indigo-100 rounded-lg shadow-lg hover:bg-indigo-200 focus:outline-none focus:bg-indigo-200"
        >
          Create Check-in
        </Link>
        </div>
